...
void ShowSettingsWindow(HWND hParent) {
    ...
    if (!g_hwndSettings) {
        g_hwndSettings = CreateWindowExW(
            ...
            CW_USEDEFAULT, CW_USEDEFAULT, 450, 700, // Increased window height so all privacy controls are visible
        ...
        CreateWindow(L"BUTTON", L"Enable Tracking Prevention (Work-in-Progress)", WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX, 
